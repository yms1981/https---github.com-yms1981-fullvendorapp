...
class SalesmanCartPage extends StatefulWidget {
  const SalesmanCartPage({super.key});
  static const String routeName = '/salesman/cart';

  @override
  State<SalesmanCartPage> createState() => _SalesmanCartPageState();
}

class _SalesmanCartPageState extends State<SalesmanCartPage> {
                ...
                MaterialButton(
                  onPressed: () async {
                    await FullVendor.instance
                        .pushNamed(SalesmanProductPage.routeName);
                    cartItems = await getCart();
          ...
          children: [
            ...
            Row(
              children: [
                ...
                Text(
                  "\$${(totalOrderValue - totalDiscount).toDecimalFormat()}",
                  style: const TextStyle(
                    fontWeight: FontWeight.bold,
                    fontSize: 18,
                    color: appPrimaryColor,
                ...
                Expanded(
                  child: MaterialButton(
                    ...
                    onPressed: isLoading
                        ...
                        : () async {
                            await FullVendor.instance
                                .pushNamed(OrderSummaryPage.routeName);
                            cartItems = await getCart();
                            if (!mounted) return;
                            setState(() {});
                          },
